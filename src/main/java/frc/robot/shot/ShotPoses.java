...
public class ShotPoses {
    ...
    public static final Pose2d CENTER_SHOT =
        new Pose2d(5.20, 4.10, Rotation2d.fromDegrees(180));

    public static final Pose2d AMP_SIDE_SHOT =
        new Pose2d(4.85, 5.75, Rotation2d.fromDegrees(165));
