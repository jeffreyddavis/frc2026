...
public class Intake extends SubsystemBase {
    ...
    private void logTelemetry() {
        ...
        Logger.recordOutput("Intake/ArmSupplyCurrent",
            armLeader.getSupplyCurrent().getValueAsDouble());

        Logger.recordOutput("Intake/RollerPercent", rollerCommanded);
        Logger.recordOutput("Intake/RollerLeftCurrent",
            rollerLeft.getOutputCurrent());
        Logger.recordOutput("Intake/RollerRightCurrent",
            rollerRight.getOutputCurrent());
    }
}