...
public class Vision extends SubsystemBase {
  ...
  @AutoLogOutput private int noGoodPosesCount = 0;

  @AutoLogOutput private boolean bolFoundGood = false;

  @AutoLogOutput public int camerasWithPoseCount = 0;
  ...
  public void periodic() {
    ...
    for (int cameraIndex = 0; cameraIndex < io.length; cameraIndex++) {
      ...
      for (var observation : inputs[cameraIndex].poseObservations) {
        ...
        // if (observation.averageTagDistance() <= 2) { // there is at least one good camera
        // observation
        bolFoundGood = true;
